...
declare global {
  ...
  const useConnectorStore: typeof import('./store/connector')['useConnectorStore']
...
declare module '@vue/runtime-core' {
  interface ComponentCustomProperties {
    ...
    >
    readonly useConnectorStore: UnwrapRef<
      typeof import('./store/connector')['useConnectorStore']
    >
