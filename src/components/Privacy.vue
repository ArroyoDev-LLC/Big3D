<template>
  <div class="text-big3dBlack">
    <div>
      <text class="text-2xl font-bold pb-3"> Privacy Policy </text>
      <text class="pb-5">Last updated: 9-30-2021</text>
      <text class="pb-2"
        >Big3D.me("us", "we", or "our") operates big3D.me (the "Site"). This
    ...
    <div>
      ...
      <text class="pb-2">
        ...
        include, but but is not limited to your name ("Personal Information").
      </text>
    </div>
    <div>
      <text class="text-2xl font-bold pb-3">Log Data</text>
      <text class="pb-2">
      ...
      <text class="pb-3">
        ...
        Protocol ("IP") address, browser type, browser version, the <br />
    ...
    <div>
      ...
      <text>
        ...
        may not able to use some portions of our Site. Security
      </text>
    </div>
    <div>
      <text>Security</text>
      <text>
        ...
        <br />Information, we cannot guarantee its absolute security.
      </text>
    </div>
    <div>
      ...
      <text>
        ...
        Privacy Policy on this page will constitute your acknowledgment <br />
