...
<template>
  <div name="parent container" class="mb-5">
    <div
      ...
      class="text-lg text-left flex flex-col ml-3 sm:ml-8"
    >
      <text>PRICING</text>
      <text class="text-5xl text-left font-bold text-black"
        >What does it <Span class="bg-yellow">cost?</Span></text
      >
    </div>
    ...
    >
      ...
      <div class="col-span-1">
        <div name="DIY" class="bg-big3dBlack p-4 m-2 text-left relative">
          ...
          <div name="included" class="flex flex-col text-left">
            ...
            <div
              class="drawer overflow-hidden"
              :class="diy2text ? 'h-48' : 'h-1'"
            >
              <ul class="list-disc text-white ml-5">
      ...
      <div class="col-span-1">
        <div name="Build" class="bg-big3dBlack p-4 m-2 text-left relative">
          ...
          <hr />
          <div name="includedb" class="flex flex-col text-left justify-between">
            <div
              class="flex justify-between cursor-pointer border-dotted border-b border-opacity-40 py-1"
            ...
            <div
              class="overflow-hidden drawer"
              :class="build2text ? 'h-64 sm:h-48' : 'h-1'"
            >
